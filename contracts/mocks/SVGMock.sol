...
contract SVGMock {
	...
	function brightenColor(ISVGTypes.Color memory source, uint32 percentage, uint8 minimumBump) external pure returns (ISVGTypes.Color memory color) {
	...
	function mixColors(ISVGTypes.Color memory color1, ISVGTypes.Color memory color2, uint32 ratioPercentage, uint32 totalPercentage) external pure returns (ISVGTypes.Color memory color) {
